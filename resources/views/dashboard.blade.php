     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.html" class="navbar-brand">Twelve <span>.</span> Cafe</a>
               </div>
                              ...
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                                             ...
                                             <h1>Enjoy our special menus every Friday</h1>
                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="about-info">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.4s">
                                   <p>I am a feeling. Like swimming under a waterfall, biting into a juicy peach, dancing till the sun comes up, holding hands with someone you love, having that third mezcal, eating berries fresh from the vine, watching your favorite film, a blue sky without a cloud in sight.</p>
                                   <p>I am everything that makes you remember you are alive and life is beautiful. Sincerely, The Wilder</p>
                              </div>
                         </div>
                    </div>
               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                         ...
                         <form action="{{url('store')}}" method="post" class="wow fadeInUp" id="contact-form" role="form" data-wow-delay="0.8s">
                              ...
                              <div class="col-md-12 col-sm-12">
                                   <input type="text" class="form-control" id="cf-subject" name="subject" placeholder="Telephone Number">

                                   <textarea class="form-control" rows="6" id="cf-message" name="message" placeholder="Tell about your menu"></textarea>
               ...
               <div class="row">
                    ...
                    <div class="col-md-3 col-sm-8">
                         <div class="footer-info">
                              ...
                              <address class="wow fadeInUp" data-wow-delay="0.4s">
                                   <p>Jln. DI Panjaitan No 128,<br> Kec. Purwoketo Selatan<br>Kab. Banyumas</p>
                              </address>
                         </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-8">
                         <div class="footer-info">
                              ...
                              <address class="wow fadeInUp" data-wow-delay="0.4s">
                                   <p>0812-3456-7890 | 021-345-789</p>
                                   <p><a href="mailto:info@company.com">twelve@company.com</a></p>
                                   <p>LINE: twelve1412 </p>
                              </address>
                         </div>
                    </div>
                    ...
                    <div class="col-md-2 col-sm-4">
                         ...
                         <div class="wow fadeInUp copyright-text" data-wow-delay="0.8s"> 
                              <p><br>Copyright &copy; 2018 <br>Twelve Cafe
                         </div>
                    </div>
